...
function Rechargement({ iddemande, idutilisateur, name, prenom, email, montant, noGutter }) {
...
// Setting default values for the props of Rechargement
Rechargement.defaultProps = {
  noGutter: false,
};

// Typechecking props for the Rechargement
Rechargement.propTypes = {
